...
st.write("""
# Naive Bayes for predicting massive blood transfusion (for unseen data)
...
if  uploaded_file is not None:
    ...
    def user_input_features():
        ...
        Pre_PLT = st.sidebar.slider('Preop platelet count (x10^3/mcL)', 101, 560, 301)
...
load_clf = pickle.load(open('mass_nb_clf.pkl', 'rb'))
...
st.write(label_name)
# labels -dictionary
names ={0:'no',1: 'massive_transfusion'}
...
st.write ("""
### [Home](https://github.com/Thara-PSU/massive_transfusion)
